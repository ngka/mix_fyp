...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private static final int EXPAND_INDICATOR_TEXT_AND_IMAGE_VIEW = 2;
    ...
    @IdRes
    private int mExpandCollapseToggleId = R.id.expand_collapse_img;
    @IdRes
    private int mExpandCollapseToggleImageId = R.id.expand_collapse_img;
    @IdRes
    private int mExpandCollapseToggleNameId = R.id.expand_collapse_name;
    ...
    private void init(AttributeSet attrs) {
        ...
        mExpandToggleType = typedArray.getInt(R.styleable.ExpandableTextView_expandToggleType, DEFAULT_TOGGLE_TYPE);
        ...
        if (mExpandToggleType == EXPAND_INDICATOR_TEXT_AND_IMAGE_VIEW) {
            mExpandCollapseToggleNameId = typedArray.getResourceId(R.styleable.ExpandableTextView_expandCollapseToggleId, R.id.expand_collapse_name);
            mExpandCollapseToggleImageId = typedArray.getResourceId(R.styleable.ExpandableTextView_expandCollapseToggleId, R.id.expand_collapse_img);
        }
    ...
    private void findViews() {
        ...
        if (mExpandToggleType == EXPAND_INDICATOR_TEXT_AND_IMAGE_VIEW) {
            TextView mToggleNameView = findViewById(mExpandCollapseToggleNameId);
            ImageView mToggleImageView = findViewById(mExpandCollapseToggleImageId);
            mExpandIndicatorController.setView(mToggleView, mToggleNameView, mToggleImageView);
        } else {
    ...
    private ExpandIndicatorController setupExpandToggleController(@NonNull Context context, TypedArray typedArray) {
        ...
        switch (mExpandToggleType) {
            case EXPAND_INDICATOR_IMAGE_BUTTON:
                expandDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_expandImageIndicator);
                collapseDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_collapseImageIndicator);
                if (expandDrawable == null) {
                    expandDrawable = getDrawable(context, R.mipmap.ic_expand_more);
                }
                if (collapseDrawable == null) {
                    collapseDrawable = getDrawable(context, R.mipmap.ic_expand_less);
                }
                expandIndicatorController = new ImageButtonExpandController(expandDrawable, collapseDrawable);
                break;
            case EXPAND_INDICATOR_TEXT_VIEW:
                expandText = typedArray.getString(R.styleable.ExpandableTextView_expandTextIndicator);
                collapseText = typedArray.getString(R.styleable.ExpandableTextView_collapseTextIndicator);
                expandIndicatorController = new TextViewExpandController(expandText, collapseText);
                break;
            case EXPAND_INDICATOR_TEXT_AND_IMAGE_VIEW:
                expandText = typedArray.getString(R.styleable.ExpandableTextView_expandTextIndicator);
                collapseText = typedArray.getString(R.styleable.ExpandableTextView_collapseTextIndicator);
                expandDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_expandImageIndicator);
                collapseDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_collapseImageIndicator);
                ...
                expandIndicatorController = new AllExpandController(expandText, collapseText, expandDrawable, collapseDrawable);
                break;
            default:
    ...
    static class ImageButtonExpandController implements ExpandIndicatorController {
        ...
        public void setView(View... toggleView) {
            mImageButton = (ImageButton) toggleView[0];
        }
    }
    ...
    static class TextViewExpandController implements ExpandIndicatorController {
        ...
        @Override
        public void setView(View... toggleView) {
            mTextView = (TextView) toggleView[0];
        }
    }

    static class AllExpandController implements ExpandIndicatorController {
        ...
        public AllExpandController(String expandText, String collapseText, Drawable expandDrawable, Drawable collapseDrawable) {
            mExpandDrawable = expandDrawable;
            mCollapseDrawable = collapseDrawable;
            mExpandText = expandText;
            mCollapseText = collapseText;
        ...
        public void changeState(boolean collapsed) {
            mTextView.setText(collapsed ? mExpandText : mCollapseText);
            mImageView.setImageDrawable(collapsed ? mExpandDrawable : mCollapseDrawable);
        }

        @Override
        public void setView(View... toggleView) {
            mTextView = (TextView) toggleView[1];
            mImageView = (ImageView) toggleView[2];
        }
    }
}