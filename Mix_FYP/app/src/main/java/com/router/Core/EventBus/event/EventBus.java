 ...
 */
package com.router.Core.EventBus.event;
...
public class EventBus {
    ...
    public synchronized void unregister(Object subscriber) {
        ...
        if (subscribedTypes != null) {
            ...
            LogUtils.e(TAG, "Subscriber to unregister was not registered before: " + subscriber.getClass());
        }
    }
    ...
    private void postSingleEvent(Object event, PostingThreadState postingState) throws Error {
        ...
        if (!subscriptionFound) {
            if (logNoSubscriberMessages) {
                LogUtils.d(TAG, "No subscribers registered for event " + eventClass);
            }
    ...
    private void handleSubscriberException(Subscription subscription, Object event, Throwable cause) {
        if (event instanceof SubscriberExceptionEvent) {
            if (logSubscriberExceptions) {
                ...
                LogUtils.e(TAG, "SubscriberExceptionEvent subscriber " + subscription.subscriber.getClass()
                        + " threw an exception:"+ cause);
                SubscriberExceptionEvent exEvent = (SubscriberExceptionEvent) event;
                LogUtils.e(TAG, "Initial event " + exEvent.causingEvent + " caused exception in "
            ...
            if (logSubscriberExceptions) {
                LogUtils.e(TAG, "Could not dispatch event: " + event.getClass() + " to subscribing class "
